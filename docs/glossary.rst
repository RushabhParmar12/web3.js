...
Using this json interface XDC3.js is able to create JavaScript object representing the smart contract and its methods and events using the :ref:`XDC3.eth.Contract object <XDC-contract>`.
